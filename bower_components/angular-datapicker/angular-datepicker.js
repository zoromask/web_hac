    ...
    link: function (scope, element, attrs, ngModel) {
      ...
      function showPicker() {
        ...
        if (position === 'absolute') {
          ...
          if(document.body.clientWidth < pos.left + 244){
            var padRight = pos.left + 244 - document.body.clientWidth;
            picker.css({ top: pos.top + pos.height, left: pos.left - padRight, display: 'block', position: position });
          }
          else{
            // var padRight = pos.left + 244 - document.body.clientWidth;
